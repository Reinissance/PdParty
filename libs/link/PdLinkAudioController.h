...
/// PdLinkAudioController: a class for managing a PdLinkAudioUnit instance within iOS
...
@interface PdLinkAudioController : NSObject
...
@property (nonatomic, strong, readonly) PdLinkAudioUnit *audioUnit;
...
///
///     PdLinkAudioController.allowBluetoothA2DP = YES;
///     PdLinkAudioController.mode = AVAudioSessionModeVideoRecording;
///     [PdLinkAudioController configurePlaybackWithSampleRate:48000 ...];
...
///
/// derive PdLinkAudioUnit when you need to access to the raw samples when using,
/// for instance, AudioBus, and call this method after init
- (instancetype)initWithAudioUnit:(PdLinkAudioUnit *)audioUnit;
...
/// saved from the current audio session PdLinkAudioController sets the category
- (AVAudioSessionCategory)currentCategory;

/// current cached audio session category options,
/// saved from the current audio session PdLinkAudioController sets/updates
