...
/// PdLinkAudioUnit: operates pd's audio input and output through an AudioUnit
///
...
/// adding a *single* instance of PdLinkAudioUnit to an internal AUGraph, multi
...
@interface PdLinkAudioUnit : AUAudioUnitV2Bridge {
@protected
...
/// want to subclass PdLinkAudioUnit and implement your own custom sample rendering
///
/// in your custom PdLinkAudioUnit subclass .m:
///
...
///     // do something with the samples, see PdLinkAudioUnit.m audioRenderCallback
///     return noErr;
/// }
///
/// // return method
...
/// creates a default instance of PdLinkAudioUnit.
...
/// * description: PdLinkAudioUnit.defaultIODescription
/// * options: 0
/// * outError: nil
